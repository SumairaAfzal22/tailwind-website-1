...
const Contact = () => {
  return (
    <div>
      <section className='border max-w-lg mx-auto my-20 p-8 bg-white shodow:md rounded-md'>
        <h2 className="text-4xl text-gray-900 font-bold mb-6 text-center" data-aos='fade-up'>Contact Us</h2>
        <form>
